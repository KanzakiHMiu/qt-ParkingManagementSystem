...
opencvRecog::opencvRecog(QWidget *parent)
    : QWidget{parent} {}

QString opencvRecog::Recog()
{
    //ui->setupUi(this);
    //Mat image=imread("C:/opencv/photoss/31408194fcc24328b6d61b04123f2ad4.png");//一定要使用绝对路径，其他可以回报错
    Mat image=imread("E:/Qt/repos/qt-ParkingManagementSystem-bright/open/VehicleLicense/Infer/test08.png");
    ...
    return chuan("G:/qfile/1466900310/FileRecv/opencv/save",21);
}

QStringList opencvRecog::readJpgFiles(const QString& folderPath, int maxFiles) {
...
Mat opencvRecog::act1(cv::Mat image)
{
...
Mat opencvRecog::Get_License_ROI(Mat src)
{
...
int opencvRecog::PixelCounter(Mat open, int ee)
{
    int ss = 0; // 初始化 ss 为 0
    int ww=0;
...
Mat opencvRecog::Horizon_Cut(Mat image){
...
QVector<QVector<int> > opencvRecog::Remove_Vertial_Border(Mat image)
{
    ...
    for (int i = 0; i < t.size(); i++)
    {
        ...
        if(whiteArea>1000)
            imwrite("G:/qfile/1466900310/FileRecv/opencv/save/save"+s+".jpg",ts);
    }
    return region1;
...
vector<Rect>opencvRecog::Remove_cahr(Mat image,Mat imag)
{
...
QString opencvRecog::chuan(const QString& folderPath, int maxFiles)
{
    QStringList jpgFiles;
    QDir dir(folderPath);
    double mx=0;
    ...
    for (const QFileInfo& fileInfo : fileInfos) {
        ...
        //-------------------------------------------------------------------遍历模版文件---------------------------------------------------------------------
        QStringList Files2;
        QDir dir2("E:/Qt/repos/qt-ParkingManagementSystem-bright/open/VehicleLicense/Data");
        ...
        for (const QFileInfo& fileInfo2 : fileInfos2) {
            ...
            QString filePath2 = "E:/Qt/repos/qt-ParkingManagementSystem-bright/open/VehicleLicense/Data/" + fileInfo2.fileName();
            qDebug()<<filePath2;
            //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~遍历文件中的图片~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
double opencvRecog::do_read(Mat temo,Mat temp){
...
QString opencvRecog::switchFunction(const std::string& key) {
...
Mat opencvRecog::cutCut(Mat gray)
{Mat deeo=gray.clone();
