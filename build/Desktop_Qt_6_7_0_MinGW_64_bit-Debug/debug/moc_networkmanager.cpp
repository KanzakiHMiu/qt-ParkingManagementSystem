...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->loginFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        case 1: _t->requestTimeout(); break;
        case 2: _t->onLoginFinished((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (NetworkManager::*)(QNetworkReply * );
        ...
        }
        {
            ...
            if (_t _q_method = &NetworkManager::requestTimeout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NetworkManager::loginFinished(QNetworkReply * _t1)
{
