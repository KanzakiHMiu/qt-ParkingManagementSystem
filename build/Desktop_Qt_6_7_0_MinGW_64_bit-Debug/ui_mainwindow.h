...
public:
    ...
    QLabel *label_date;
    QWidget *InOutSituation_tab;
    QDateEdit *startDateEdit_2;
    QPushButton *searchTransactionButton_2;
    QLabel *label_date_2;
    QDateEdit *endDateEdit_2;
    QWidget *Monitor_tab;
    QLabel *cameraFeedLabel;
    QComboBox *cameraComboBoxLive;
    QPushButton *switchCameraButton;
    QRadioButton *cameraLive;
    QRadioButton *cameraRecord;
    QComboBox *cameraComboBoxRecord;
    QWidget *Announcement_tab;
    QTextEdit *announcementTextEdit;
    QPushButton *publishAnnouncementButton;
    QLabel *label_announcementEdit;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        startDateEdit->setDateTime(QDateTime(QDate(1999, 12, 28), QTime(0, 0, 0)));
        ...
        endDateEdit->setDateTime(QDateTime(QDate(2009, 12, 27), QTime(0, 0, 0)));
        endDateEdit->setCurrentSection(QDateTimeEdit::YearSection);
        label_date = new QLabel(ParkingTransaction_tab);
        label_date->setObjectName("label_date");
        label_date->setGeometry(QRect(370, 20, 21, 16));
        QFont font;
        font.setPointSize(18);
        label_date->setFont(font);
        tabWidget->addTab(ParkingTransaction_tab, QString());
        InOutSituation_tab = new QWidget();
        InOutSituation_tab->setObjectName("InOutSituation_tab");
        startDateEdit_2 = new QDateEdit(InOutSituation_tab);
        startDateEdit_2->setObjectName("startDateEdit_2");
        startDateEdit_2->setGeometry(QRect(199, 10, 151, 31));
        startDateEdit_2->setDateTime(QDateTime(QDate(1999, 12, 27), QTime(0, 0, 0)));
        startDateEdit_2->setCurrentSection(QDateTimeEdit::YearSection);
        searchTransactionButton_2 = new QPushButton(InOutSituation_tab);
        searchTransactionButton_2->setObjectName("searchTransactionButton_2");
        searchTransactionButton_2->setGeometry(QRect(640, 10, 101, 31));
        label_date_2 = new QLabel(InOutSituation_tab);
        label_date_2->setObjectName("label_date_2");
        label_date_2->setGeometry(QRect(370, 20, 21, 16));
        label_date_2->setFont(font);
        endDateEdit_2 = new QDateEdit(InOutSituation_tab);
        endDateEdit_2->setObjectName("endDateEdit_2");
        endDateEdit_2->setGeometry(QRect(410, 10, 151, 31));
        endDateEdit_2->setDateTime(QDateTime(QDate(2009, 12, 26), QTime(0, 0, 0)));
        endDateEdit_2->setCurrentSection(QDateTimeEdit::YearSection);
        tabWidget->addTab(InOutSituation_tab, QString());
        ...
        cameraComboBoxLive = new QComboBox(Monitor_tab);
        cameraComboBoxLive->setObjectName("cameraComboBoxLive");
        cameraComboBoxLive->setGeometry(QRect(1050, 80, 191, 23));
        switchCameraButton = new QPushButton(Monitor_tab);
        switchCameraButton->setObjectName("switchCameraButton");
        switchCameraButton->setGeometry(QRect(1060, 460, 171, 51));
        QFont font1;
        font1.setPointSize(12);
        switchCameraButton->setFont(font1);
        cameraLive = new QRadioButton(Monitor_tab);
        cameraLive->setObjectName("cameraLive");
        cameraLive->setGeometry(QRect(1060, 40, 51, 21));
        cameraRecord = new QRadioButton(Monitor_tab);
        cameraRecord->setObjectName("cameraRecord");
        cameraRecord->setGeometry(QRect(1060, 230, 51, 21));
        cameraComboBoxRecord = new QComboBox(Monitor_tab);
        cameraComboBoxRecord->setObjectName("cameraComboBoxRecord");
        cameraComboBoxRecord->setGeometry(QRect(1050, 270, 191, 23));
        ...
        label_announcementEdit = new QLabel(Announcement_tab);
        label_announcementEdit->setObjectName("label_announcementEdit");
        label_announcementEdit->setGeometry(QRect(0, 10, 171, 21));
        QFont font3;
        font3.setPointSize(16);
        label_announcementEdit->setFont(font3);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_date->setText(QCoreApplication::translate("MainWindow", "~", nullptr));
        ...
        startDateEdit_2->setDisplayFormat(QCoreApplication::translate("MainWindow", "yyyy/MM/dd", nullptr));
        searchTransactionButton_2->setText(QCoreApplication::translate("MainWindow", "\346\237\245\350\257\242", nullptr));
        label_date_2->setText(QCoreApplication::translate("MainWindow", "~", nullptr));
        endDateEdit_2->setDisplayFormat(QCoreApplication::translate("MainWindow", "yyyy/MM/dd", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(InOutSituation_tab), QCoreApplication::translate("MainWindow", "\346\237\245\347\234\213\345\207\272\345\205\245\346\203\205\345\206\265", nullptr));
        ...
        cameraLive->setText(QCoreApplication::translate("MainWindow", "\345\256\236\346\227\266", nullptr));
        cameraRecord->setText(QCoreApplication::translate("MainWindow", "\345\275\225\345\203\217", nullptr));
        ...
        label_announcementEdit->setText(QCoreApplication::translate("MainWindow", "\347\274\226\350\276\221\345\205\254\345\221\212\357\274\232", nullptr));
